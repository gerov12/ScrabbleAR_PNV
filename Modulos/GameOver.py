...
def main (puntos_jugador,puntos_computadora,nombre, tema, nivel, tiempo, modificado, modificado2):
    ...
    try:
        ...
        if puntos_jugador > puntos_computadora:
            fin = [[sg.Image(filename = "Imagenes/Fin/Ganador.png", size=(630,630))], [sg.Button('Volver a Jugar'),sg.Button('Menú'), sg.Button('Salir', button_color=('black','red'))],
            [sg.Text('', size=(1,1))]]
            print('Resultado Final             ---> Gano El Jugador')

        elif puntos_computadora > puntos_jugador:
            fin = [[sg.Image(filename = "Imagenes/Fin/Perdedor.png", size=(630,630))], [sg.Button('Volver a Jugar'),sg.Button('Menú'),sg.Button('Salir', button_color=('black','red'))],
            [sg.Text('', size=(1,1))]]
            print('Resultado Final             ---> Gano La Computadora')

        else:
            fin = [[sg.Image(filename = "Imagenes/Fin/Empate.png", size=(630,630))], [sg.Button('Volver a Jugar'),sg.Button('Menú'), sg.Button('Salir', button_color=('black','red'))],
                [sg.Text('', size=(1,1))]]
